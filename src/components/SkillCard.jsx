...
//   const x = useTransform(scrollProgress, [0, 0.3, 0.8], [0, xOffset/2, xOffset], { clamp: true });
//   const y = useTransform(scrollProgress, [0, 0.3, 0.8], [0, yOffset/2, yOffset], { clamp: true });
//   const rotateY = useTransform(scrollProgress, [0.3, 0.8], [0, 180], { clamp: true });
//   const opacity = useTransform(scrollProgress, [0, 0.3, 0.8], [0.7, 0.8, 1], { clamp: true });
...
const SkillCard = ({ skill, index, scrollProgress }) => {
  ...
  // Scroll-based animation transforms (slower spreading and flipping)
  ...
  const rotateY = useTransform(scrollProgress, [0.2, 0.8, 1], [0, 90, 180], { clamp: true });
